        ...
        <div className="grid grid2">
          {topic.items.map((it, idx) => (
            <div className="card" key={idx}>
              ...
              <p className="muted small" style={{lineHeight:1.6, marginTop:6}}>
                This tradition reflects India's rich cultural diversity and has evolved over centuries. 
                It continues to play an important role in regional identity, community celebrations, 
                and the preservation of heritage through generations.
              </p>
            </div>
          ))}
        </div>
