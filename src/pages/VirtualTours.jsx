...
const tourStepsBySite = {
  "taj-mahal": [
    { 
      ...
      text: "The grand red sandstone gateway (Darwaza-i-Rauza) frames the Taj Mahal perfectly. Quranic calligraphy and optical design make the monument appear larger as you walk closer.",
      image: "/images/entrance.jpg"
    },
    { 
      title: "Marble Mausoleum", 
      text: "The central structure is made of Makrana white marble and decorated with intricate pietra dura (stone inlay). Inside lie the cenotaphs of Mumtaz Mahal and Shah Jahan.",
      image: "https://upload.wikimedia.org/wikipedia/commons/d/da/Taj-Mahal.jpg"
    },
    { 
      title: "Charbagh Gardens", 
      text: "The Mughal Charbagh garden symbolizes paradise with water channels, reflecting pools, and perfect symmetry aligned with Persian garden traditions.",
  ...
  return (
    <div className="grid" style={{gap:16}}>
      ...
      <div className="card" style={{padding:0, overflow:'hidden'}}>
        <img 
          src={steps[step]?.image || site.cover} 
          alt={site.name} 
          style={{
            width:'100%',
            height:320,
